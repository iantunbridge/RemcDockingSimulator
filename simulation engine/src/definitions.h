...
#define MAX_TRANSLATION						5.0f
#define INITIAL_ROTATIONAL_STEP				0.2f // rads
#define MIN_ROTATION						0.1f
#define MAX_ROTATION						0.5f
...
#define bool_recordAllSamples				false

#define const_repulsive_cutoff				15.0f //repulsive crowder cutoff
